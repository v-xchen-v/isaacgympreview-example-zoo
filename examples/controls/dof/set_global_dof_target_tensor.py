...
actor_dof_states = target_dof_state[actor_dof_start: actor_dof_start + num_actor_dofs, :]
...
gym.set_dof_position_target_tensor(sim, gymtorch.unwrap_tensor(target_position))
gym.set_dof_velocity_target_tensor(sim, gymtorch.unwrap_tensor(target_velocity))
