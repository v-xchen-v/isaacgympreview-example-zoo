...
while not gym.query_viewer_has_closed(viewer):
    ...
    def reset():
        ...
        gym.set_actor_root_state_tensor_indexed(sim, gymtorch.unwrap_tensor(root_states),
                                                 gymtorch.unwrap_tensor(torch.arange(num_envs, device='cuda', dtype=torch.int32)),
                                                 num_envs)
        ...
        gym.set_dof_state_tensor_indexed(sim, gymtorch.unwrap_tensor(global_dof_states),
                                 gymtorch.unwrap_tensor(torch.arange(num_envs, device='cuda', dtype=torch.int32)),
                                 num_envs)
